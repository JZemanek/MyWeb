    ...
    if (!card.classList.contains("card-active")) {
      ...
      if (rect.left !== centerX && rect.right !== centerX) {
        card.style.transform = `translate(${
          centerX - rect.left
        }px) translateY(${offsetOperator}${startOffsetY}px)`;
      } else {
      ...
      card.addEventListener(
        ...
        (event) => {
          if (
            ...
            card.classList.contains("card-expanding")
          ) {
            ...
            card.addEventListener(
              ...
              (event) => {
                if (
                  ...
                  card.classList.contains("expand-x")
                ) {
                  ...
                  card.addEventListener(
                    ...
                    (event) => {
                      if (
                        ...
                        card.classList.contains("expand-y")
                      ) {
  ...
  btn.addEventListener("click", () => {
    ...
    if (card.classList.contains("card-active")) {
      ...
      card
        ...
        .classList.add("skill-card-footer-visible");
...
const texts = ["Java, Spring Boot, SQL", "HTML, CSS, JavaScript, Vue.js"]; // Střídané texty
